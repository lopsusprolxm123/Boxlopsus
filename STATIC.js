...
try {
  ...
  console.error('\x1B[31mXCDDOS Missing ua.txt file\n' + error);
  process.exit(-1);
}
...
if (cluster.isMaster) {
  ...
  console.clear();
  console.log('\n\n    XCDDOS\n\n    XinnClay Fixxed\n\n');
  console.log('\x1B[33m(\x1B[33m!\x1B[37m) \x1B[33mSending Power to Target!.');
  console.log('\x1B[31mXCDDOS POWER KILLER');
  setTimeout(() => {
    process.exit(1);
  }, time * 1000);
} else {
